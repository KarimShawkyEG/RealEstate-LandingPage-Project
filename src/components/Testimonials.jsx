...
const Testimonials = () => {
    return (
        <motion.div
            ...
            id='Testimonials' className='container mx-auto py-10 lg:px-32 w-ful overflow-hidden'>
            ...
            <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from Our Beloved Customers</p>
