...
const Projects = () => {
    ...
    return (
        <motion.div
            ...
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Projects <span className='underline underline-offset-4 decoration-1 under font-light'>Delivered</span></h1>
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Building Legacies Through Properties</p>
